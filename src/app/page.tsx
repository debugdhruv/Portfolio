...
//             className="fixed bottom-0 z-[100] text-right text-white bg-primary px-8 py-32 flex-col items-right justify-start flex space-y-10 w-screen h-screen">
//             <Link href="/about" className="text-4xl font-semibold hover:text-primary">About</Link>
//             <Link href="/projects" className="text-4xl font-semibold hover:text-primary">Projects</Link>
//             <Link
//               href="https://drive.google.com/file/d/1QajQRx9Xu8NeX3yaG_dmtDn6XNjkS4YO/view?usp=sharing"
//               target="_blank"
//               rel="noopener noreferrer"
//               className="text-4xl font-semibold hover:text-primary">
//               Resume
//             </Link>
//             <Link href="#footer" className="text-4xl font-semibold hover:text-primary">
//               Contact
//             </Link>
//             <Link
