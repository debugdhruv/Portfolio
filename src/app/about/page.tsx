...
//                 viewport={{ once: true }}
//                 className="text-4xl md:text-5xl lg:text-6xl font-italiana font-black text-foreground leading-tight"
//               >
//                 Product Designer,
//               </motion.h1>
//               <motion.h2
...
//             className="space-y-6"
//           >
//             <h2 className="text-2xl font-whyte font-bold text-foreground">Skills & Interest</h2>
...
//             className="space-y-6"
//           >
//             <h2 className="text-2xl font-whyte font-bold text-foreground">Experience</h2>

//             <div className="space-y-8">
//               {/* DevGrowth Solutions */}
//               <div className="space-y-2">
//                 <h3 className="font-bold text-foreground">DevGrowth Solutions</h3>
...
//               {/* AbC@ Xyz.com */}
//               <div className="space-y-2">
//                 <h3 className="font-bold text-foreground">AbC@ Xyz.com</h3>
...
//               <div className="space-y-2">
//                 <h3 className="font-bold text-foreground">XYZ * abc.com Solutions</h3>
//                 <p className="text-sm text-muted-foreground">2023 - 2024 (Hybrid)</p>
//                 <p className="text-sm text-foreground">
...
//               <h2 className="text-2xl font-whyte font-bold text-foreground">Education</h2>

//               <div className="space-y-6">
//                 {/* LNCT */}
//                 <div className="space-y-2">
//                   <h3 className="font-bold text-foreground">Lakshmi Narain College of Technology</h3>
...
//                 {/* Shri Vaishnav */}
//                 <div className="space-y-2">
//                   <h3 className="font-bold text-foreground">Shri Vaishnav Polytechnic College</h3>
...
//             {/* Contact */}
//             <div className="space-y-6">
//               <h2 className="text-2xl font-whyte font-bold text-foreground">Contact</h2>
...
//                 {/* Socials */}
//                 <div>
//                   <h4 className="font-bold text-foreground mb-3">Socials</h4>
...
//         transition={{ duration: 0.8, ease: "easeOut" }}
//         viewport={{ once: true }}
//         className="w-full max-w-7xl mx-auto px-4 py-8 border-t border-foreground/20"
//       >
//         <div className="flex justify-end">
//           <p className="text-sm text-foreground">© 2024 - All Rights Reserved</p>
//         </div>
//       </motion.footer>
//     </motion.main>
//   );
