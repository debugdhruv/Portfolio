...
//   return (
//     <header className="fixed top-0 z-50 w-full backdrop-blur-lg bg-background/30">
...
//             <li>
//               <Link
//                 href="https://drive.google.com/file/d/1QajQRx9Xu8NeX3yaG_dmtDn6XNjkS4YO/view?usp=sharing" target="_blank" rel="noopener noreferrer"
